/**
 * Legacy simplified build (moved to legacy/). This file is retained for
 * reference only and should not run as part of normal CI/builds.
 *
 * If you need to run it manually: npm run legacy-build (from bot/)
 */
import fs from 'fs';
